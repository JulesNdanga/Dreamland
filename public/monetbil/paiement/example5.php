...
Monetbil::setUser(12);
Monetbil::setFirst_name('Jules');
Monetbil::setLast_name('Ndanga');
Monetbil::setEmail('julesndanga7@gmail.com');
Monetbil::setLogo('http://coachingschool.fnitgroup.com/img/logo.png');
...
<?php if (Monetbil::MONETBIL_WIDGET_VERSION_V2 == Monetbil::getWidgetVersion()): ?>
    <form action="<?php echo $payment_url; ?>" method="post" data-monetbil="form">
        <button type="submit" class="btnmnb" id="monetbil-payment-widget">Acheter</button>
    </form>
<?php else: ?>
    <a class="btnmnb" href="<?php echo $payment_url; ?>" id="monetbil-payment-widget">Acheter</a>
<?php endif; ?>
