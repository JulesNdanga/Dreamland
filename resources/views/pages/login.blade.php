...
<head>
    <title>Dreamland - MEMBER LOGIN</title>
    <meta charset="UTF-8">
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="POST" action="conxCoash.php">
                    ...
                    <div class="text-center p-t-50">
                        <a class="txt" href="/">
                            <i class="fa fa-arrow-circle-left m-l-5" aria-hidden="true"></i>
                            HOME
                        </a>
                        <i class="fa fa-arrows-h m-l-5" aria-hidden="true"></i>
                        <a class="txt" href="/register">
                            REGISTER
