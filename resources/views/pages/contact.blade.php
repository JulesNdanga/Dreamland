                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pl-45">
                        ...
                        <div class="contact-info-list mb-40">
                            <ul>
                                <li><i class="fas fa-map-marker-alt"></i>Atlantic Bank ancien 3e, Douala</li>
                                <li><i class="fas fa-envelope"></i>info@dreamland.com</li>
                            </ul>
                        </div>
    ...
    <script>
        function basicmap() {
                    ...
                    var mapOptions = {
                        ...
                        center: new google.maps.LatLng(4.061536, 9.786072), // New York
                    ...
                    var marker = new google.maps.Marker({
                        position: new google.maps.LatLng(4.061536, 9.786072),
                        map: map,
