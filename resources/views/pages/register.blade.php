...
<body>
                                    ...
                                    <li>
                                        <div class="header-top-mail">
                                            <p><span>|</span><i class="far fa-envelope"></i><a
                                                    href="mailto:info@gmail.com">info@dreamland.com</a></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div id="mobile-menu" class="navbar-wrap d-none d-lg-flex">
                                    <ul>
                                        ...
                                        <li><a href="#">OUR ACTIVITIES</a>
                                            <ul class="submenu">
                                                <li><a href="#">OUR TOURNAMENTS </a></li>
                                        ...
                                        <li class="show"><a href="/register">REGISTER</a></li>
    ...
    <main>
                ...
                <div class="row align-items-start justify-content-center">
                    <div class="col-md-10">
                        <div class="contact-form-wrap">
                            <span class="text-center" id="un"
                                style="margin-left:48%; border:1px solid #007bff; border-radius:50%; font-size:25px; font-weight:bold; color:white;background-color:#007bff;">&nbsp;&nbsp;1&nbsp;&nbsp;
                            </span>
                            <span class="text-center" id="deux"
                                style="display:none;margin-left:48%; border:1px solid #007bff; border-radius:50%; font-size:25px; font-weight:bold; color:white;background-color:#007bff;">&nbsp;&nbsp;2&nbsp;&nbsp;
                            </span>
                                 ...
                                 <div class="row">
                                    <div class="col-lg-6">
                                        <div class="contact-form-group">
                                            <input type="text" class="form-control" name="nom" id="contactName" placeholder="Your Last Name *" required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="contact-form-group">
                                            <input type="text" class="form-control" name="prenom" id="contactName2" placeholder="Your First Name *" required>
                                            <i class="far fa-user"></i>
                                            <div class="form-validate-icons">
                                                <span></span>
                                            </div>
                                    ...
                                    <div class="col-lg-6 ">
                                        <div class="contact-form-group custom-select-wrapper">
                                            <select name="Genre" class="form-control" id="contactSubject">
                                    ...
                                    <div class="col-lg-6 ">
                                        <div class="contact-form-group">
                                            <input type="text" class="form-control" name="LieuNaissance" id="LieuNaiss" placeholder="PLACE OF BIRTH *" required>
                                    ...
                                    <div class="col-lg-6 ">
                                        <div class="contact-form-group">
                                            <input type="text" class="form-control" name="LieuResid" id="LieuResid" placeholder="RESIDENCE ADDRESS *" required>
                                            <i class="far fa-map"></i>
                                            <div class="form-validate-icons">
                                                <span></span>
                                            </div>
                                    ...
                                    <div class="col-lg-6 ">
                                        <div class="contact-form-group">
                                            <input type="password" class="form-control" name="ConfirmP" id="confP" placeholder="CONFIRM PASSWORD *" required>
                                            <i class="far fa-lock"></i>
                                            <div class="form-validate-icons">
                                                <span></span>
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="contact-form-group">
                                            <div class="custom-control custom-checkbox d-flex align-items-center">
                                                ...
                                                <span>I accepted <a href="#" data-toggle="modal" data-target="#termsModal" id="termssToggle">Terms &
                                                        Conditions</a></span>
                                            </div>
                                        </div>
                                    </div>
        ...
        <!-- Success Modal Start -->
        <div class="modal fade custom-modal" id="formSuccessModal" tabindex="-1" role="dialog"
                        ...
                        <div class="form-popup-inner">
                            <div class="form-icon success">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130.2 130.2">
                                    <circle class="path circle" fill="none" stroke-width="6" stroke-miterlimit="10"
                                        cx="65.1" cy="65.1" r="62.1" />
                                    <polyline class="path check" fill="none" stroke-width="6" stroke-linecap="round"
        ...
        <!-- Danger Modal Start -->
        <div class="modal fade custom-modal" id="formDangerModal" tabindex="-1" role="dialog"
            aria-labelledby="formDangerModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                        ...
                        <div class="form-popup-inner">
                            <div class="form-icon danger">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130.2 130.2">
                                    <circle class="path circle" fill="none" stroke-width="6" stroke-miterlimit="10"
                                        cx="65.1" cy="65.1" r="62.1" />
                                    <line class="path line" fill="none" stroke-width="6" stroke-linecap="round"
                        ...
                        <div class="col-12">
                            <div class="newsletter-wrap">
                                <div class="section-title newsletter-title">
                                    <h2 class="text-light">Our <span>Newsletter</span></h2>
                                </div>
                                <div class="newsletter-form">
                                    <form action="#">
                                        ...
                                        <button class="text-light">SUBSCRIBE <i class="fas fa-paper-plane"></i></button>
                                    </form>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="copyright-text">
                            <p>Copyright © 2021 <a href="#">Dreamland</a> All Rights Reserved.</p>
                        </div>
                    </div>
